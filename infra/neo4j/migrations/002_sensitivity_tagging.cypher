...
// -----------------------------------------------------------------------------
// Step 5 + 6: SKIPPED (Community Edition)
// IS NOT NULL constraints require Enterprise Edition.
// sensitivity_level validation is enforced at the application layer:
//   - kg_writer.py sets sensitivity_level = 'normal' as default on every write
//   - _require() validation guards every write function
// -----------------------------------------------------------------------------
